...
# These functions are intended for internal use and are not fully tested.
# They may contain errors, although their core functionality has been verified.
...
def compute_geometry_bounds(geometry_list):
    ...
    for obj in geometry_list:
        ...
        if isinstance(obj, mp.geom.Prism):
            ...
            for vertex in vertices:
                ...
                points.extend([
                    ...
                    (vertex.x + V.x, vertex.y + V.y, vertex.z + V.z)])
        elif isinstance(obj, mp.geom.Cylinder):
